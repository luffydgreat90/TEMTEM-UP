...
class TemtemServiceTest: TemtemService {
    func fetchAllTemtems() -> TemtemLoader {
        return Future { promise in
            let mockTemtemViewModel1 = TemtemViewModel(number: 1, temtemName: "Anahir", portraitWikiUrl: makeURL(), largeIcon: makeURL(), largeLumaIcon: makeURL(), numberLabel: "#1", gameDescription: "test description", types: [TemtemTypes.crystal], traits: ["Trauma","Flawed Crystal"], wikiUrl: "", tvYields: [:], techniques: [])
